...
public class phase2Connector
{
	...
	public phase2Connector() throws Exception
	{
		//georgia.eng.utah.edu
		String sshHost = "georgia.eng.utah.edu";
		String sshUser = "5530u32";
		String sshPassword = "2bj93k1n";
		...
		String url = "jdbc:mysql://localhost:" + lport + "/5530db32?allowMultiQueries=true";
		String dbUser = "5530u32";
		String dbPassword = "2bj93k1n";
